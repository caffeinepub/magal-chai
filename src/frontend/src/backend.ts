...
export class Backend implements backendInterface {
    ...
    async addMenuItem(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: boolean, arg5: boolean): Promise<MenuItem> {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: Array<OrderItem>, arg3: bigint): Promise<Order> {
        if (this.processError) {
            try {
